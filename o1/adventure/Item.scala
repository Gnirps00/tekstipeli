...
/** The class `Gem` represents gems in a text adventure game. Each gem has a name
  * and a  *  longer description. 
*/
class Gem(name: String, description: String) extends Item(name, description) {
  
}

/** The class `Key` represents keys in a text adventure game. Each key has a name
  * and a  *  longer description. 
*/
